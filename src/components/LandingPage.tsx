  ...
  return (
    <div className={`lp-root ${visible ? 'lp-visible' : ''}`} role="main">
      ...
      <section className="lp-hero" aria-label="Hero">
        ...
        <form className="lp-hero-cta lp-name-form" onSubmit={handleSubmit}>
          <button className="lp-btn-primary" type="submit" aria-label="Build My Resume Now - Open JobFit AI App">
