        ...
        <>
            ...
            <form onSubmit={handleSubmit} className="sm-form">
                <div className="sm-scroll">
                    ...
                    {/* Profile */}
                    <div className="sm-section sm-section-profile">
                    ...
                    {/* Provider Tabs */}
                    <div className="sm-section sm-section-provider">
                    ...
                    {/* API Key */}
                    <div className="sm-section sm-section-key">
                    ...
                    {/* Model */}
                    <div className="sm-section sm-section-model">
                    ...
                    {/* Data */}
                    <div className="sm-section sm-section-data sm-section-last">
                        ...
                        <div className="sm-data-btns">
                            ...
                            {onDeleteSavedDocuments && (
                                <button
                                    type="button"
                                    className="sm-data-btn sm-data-btn-danger"
                                    onClick={onDeleteSavedDocuments}
                                    disabled={savedDocumentCount === 0}
                                >
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    ...
                                    {savedDocumentCount > 0 ? `Delete saved docs (${savedDocumentCount})` : 'Delete saved docs'}
                                </button>
                            )}
                        </div>
                        <p className="sm-data-hint">Exports include draft, history, preferences, and API keys. Deleting saved docs only removes generated document history.</p>
                    </div>
                </div>
