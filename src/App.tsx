...
function AppContent() {
  ...
  const handleGenerateCoverLetter = async () => {
    ...
    try {
      ...
      const cleanedCL = cleanCoverLetterData(result.coverLetter);
        ...
        <header className="app-header no-print">
          <div className="header-left">
            <div className="logo">
              ...
              <span className="logo-text">JOBFIT <span className="logo-byline" style={{ fontSize: '0.85em', opacity: 0.9, marginLeft: '10px', fontWeight: 500, letterSpacing: '0.02em', textTransform: 'none' }}>by Tanmay</span></span>
            </div>
          </div>
