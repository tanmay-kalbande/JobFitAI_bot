...
async function callGroqAI(prompt: string, settings: AISettings): Promise<string> {
...
7. CERTIFICATIONS FORMAT: Each certification string MUST follow this format: "Certification Name | Issuer · Date". Example: "AWS Cloud Technical Essentials | Amazon Web Services · Dec 2024". If only the name is available, just use the name without a pipe. If only name and issuer, use "Cert Name | Issuer".
